...
*/
static GUI_CONST_STORAGE GUI_COLOR _Colorslemon[] = {
#if (GUI_USE_ARGB == 0)
...
static GUI_CONST_STORAGE GUI_LOGPALETTE _Pallemon = {
  256,  // Number of entries
  0,    // No transparency
  (const LCD_COLOR *)&_Colorslemon[0]
};

static GUI_CONST_STORAGE unsigned char _aclemon[] = {
  ,
  ...
  ,
...
GUI_CONST_STORAGE GUI_BITMAP bmlemon = {
  55, // xSize
  54, // ySize
  55, // BytesPerLine
  8, // BitsPerPixel
  (const unsigned char *)_aclemon,  // Pointer to picture data (indices)
  &_Pallemon,  // Pointer to palette
  NULL
};
