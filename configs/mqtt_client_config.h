...
#define MQTT_PUB_TOPIC_PATTERN            "maskvend/%d"
#define MQTT_PUB_TOPIC_MAX_LEN            (sizeof(MQTT_PUB_TOPIC_PATTERN) + 8)
#define MQTT_SUB_TOPIC                    "maskvend/+"
...
#define ENABLE_LWT_MESSAGE                ( 0 )
  ...
  #define MQTT_WILL_TOPIC_PATTERN         MQTT_PUB_TOPIC_PATTERN "/will"
  #define MQTT_WILL_TOPIC_MAX_LEN         (sizeof(MQTT_WILL_TOPIC_PATTERN) + 8)
...
#define MQTT_CLIENT_IDENTIFIER            "MY_TRUSTM_MQTT_CLIENT_IDENTIFIER"
#else
 ...
 */
#if (FEATURE_TRUST_M == ENABLE_FEATURE)
#define GENERATE_UNIQUE_CLIENT_ID         ( 0 ) // use a fixed MQTT_CLIENT_IDENTIFIER
#else
