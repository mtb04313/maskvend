 ...
 * Global variable
 ******************************************************************************/
cy_thread_t g_led_task_handle = NULL;
cy_queue_t g_led_command_data_q = NULL;
...
*
*******************************************************************************/
void task_led(cy_thread_arg_t param)
{
    cyhal_pwm_t pwm_led;
    bool led_on = true;
    ...
    for(;;)
    {
        ...
        if (CY_RSLT_SUCCESS == cy_rtos_get_queue(   &g_led_command_data_q,
                                                    (void *)&led_cmd_data,
