...
# added to the build
#
COMPONENTS=FREERTOS LWIP MBEDTLS WICED_BLE WCM SECURE_SOCKETS EMWIN_OSNTS RTOS_AWARE PSOC6_FREERTOS

# Like COMPONENTS, but disable optional code that was enabled by default.
DISABLE_COMPONENTS=

OPTIGAFLAGS=\
	OPTIGA_LIB_EXTERNAL='"optiga_lib_config_mtb.h"' TRUSTM_USE_HAL_2_1
...
# LwIP SNTP files
#SOURCES+=$(MYLWIP)/src/apps/sntp/sntp.c
...
DEFINES=$(MBEDTLSFLAGS) $(OPTIGAFLAGS) CYBSP_WIFI_CAPABLE CY_RETARGET_IO_CONVERT_LF_TO_CRLF CY_RTOS_AWARE
